...
def main():
    ...
    gather_artist_details(all_artist_ids, headers, all_artists, all_top_tracks, all_related_artists)
    gather_song_details(all_track_ids, headers, all_songs)
    gather_audio_features(all_track_ids, headers, all_audio_features)
    ...
    # Save data to JSON files and convert to CSV
    ...
    logger.info("Data extraction and conversion completed.")
